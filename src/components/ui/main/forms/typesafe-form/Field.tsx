...
export const RadioCardsField = React.memo(withControlledInput<FieldComponent<RadioGroupProps>>(forwardRef<HTMLInputElement, FieldComponent<RadioGroupProps>>(
   ({ name, ...props }, ref) => {
      ...
      return <RadioGroup
         ...
         radioWrapperClassName="block w-full p-4 cursor-pointer transition border border-gray-200 rounded-md data-checked:bg-white data-checked:ring-2 data-checked:ring-indigo-500"
